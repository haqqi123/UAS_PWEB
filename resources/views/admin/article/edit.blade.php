...
@section('content')
    <div class="space-y-6">
        ...
        <form id="article-form" action="{{ route('admin.article.update', $article) }}" method="POST"
            ...
            <div class="bg-white shadow-md rounded-2xl">
                <div class="p-6 space-y-6">
                        ...
                        <div class="p-4 bg-gray-50 rounded-xl">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-lg font-semibold text-gray-900">{{ number_format($article->views) }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="p-4 bg-gray-50 rounded-xl">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-1 text-sm text-gray-500">
                                    Format: JPG, JPEG, PNG. Maksimal 2MB. Biarkan kosong jika tidak ingin mengubah
                                    thumbnail.
                                </p>
                                @error('thumbnail')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <textarea name="isi" id="editor" style="display: none;">{{ old('isi', $article->isi) }}</textarea>
                        @error('isi')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
