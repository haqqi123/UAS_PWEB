...
@section('content')
    <div class="space-y-6">
        ...
        <form id="organization-form" action="{{ route('admin.organization.store') }}" method="POST"
                ...
                <div class="grid gap-6 lg:grid-cols-2">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="jabatan" value="{{ old('jabatan') }}" required maxlength="50"
                                class="w-full p-2 border-2 border-gray-300 rounded-lg focus:border-primary focus:ring focus:ring-primary/20"
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <p class="text-xs text-gray-500">
                                ...
                                Gambar akan di-crop menjadi persegi.
                            </p>
                        </div>
                    </div>
                </div>
