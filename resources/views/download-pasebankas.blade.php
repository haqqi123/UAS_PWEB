...
@section('title', 'Download PasebanKas Apps')
                ...
                <div class="max-w-xl mx-auto bg-white rounded-2xl shadow-lg p-8 mb-8 animate-fade-in-up">
                    <div class="flex flex-col items-center text-center space-y-6">
                        ...
                        <div class="text-center">
                            <h2 class="text-3xl font-bold text-primary mb-3">PasebanKas Apps</h2>
                            <p class="mb-6 text-lg text-gray-600 leading-relaxed">Aplikasi pencatatan keuangan untuk mengelola transaksi UMKM di Desa Kalibaru Manis dengan laporan grafik yang mudah dipahami.</p>
                        ...
                        <!-- Download Button -->
                        @if(file_exists(public_path('apk/PasebanKas Apps V2.apk')))
                            <a href="{{ $appInfo['download_url'] }}" 
                               ...
                               download="pasebankas-apps-v2.apk">
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl p-6 border border-primary/20">
                            <div class="flex items-center sm:items-start mb-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-600 leading-relaxed text-sm">Pemerintah desa memantau perkembangan UMKM melalui laporan bulanan dan tahunan, serta meninjau data keuangan untuk memastikan optimalisasi usaha masyarakat.</p>
                                </div>
                            </div>
                        </div>
                        <!-- UMKM Role -->
                        <div class="bg-gradient-to-br from-secondary/10 to-secondary/5 rounded-xl p-6 border border-secondary/20">
                            <div class="flex items-center sm:items-start mb-4">
                                ...
                                <div class="flex-1">
                                    <h4 class="text-xl font-semibold text-gray-900 mb-2">UMKM</h4>
                                    <p class="text-gray-600 leading-relaxed text-sm">Mencatat transaksi harian dan melihat laporan grafik bulanan/tahunan untuk memantau arus kas, persentase keuntungan, dan kerugian usaha.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="text-sm">
                                ...
                                <p class="text-amber-700">
                                    Aplikasi ini memerlukan izin untuk mengakses penyimpanan untuk menyimpan data keuangan dengan aman. 
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 leading-relaxed">
                                Aplikasi ini menggunakan enkripsi data untuk melindungi informasi keuangan UMKM. 
                                Data transaksi disimpan secara lokal dan dapat disinkronkan dengan server aman desa.
                            </p>
                        </div>
                    </div>
                </div>
